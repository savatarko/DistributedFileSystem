...
public class BasicMessage implements Message {
	...
	public BasicMessage(MessageType type, int senderPort, String senderIpAddress, int receiverPort, String receiverIpAddress) {
		this.type = type;
	...
	public BasicMessage(MessageType type, int senderPort, String senderIpAddress, int receiverPort, String receiverIpAddress, String messageText) {
		this.type = type;
		this.senderPort = senderPort;
		this.receiverPort = receiverPort;
	...
	public String toString() {
		return "[" + ChordState.chordHash("localhost:" + getSenderPort()) + "|" + getSenderPort() + "|" + getMessageId() + "|" +
					getMessageText() + "|" + getMessageType() + "|" +
					getReceiverPort() + "|" + ChordState.chordHash("localhost:" + getReceiverPort()) + "]";
	}
	...
	public void updateReceiver(int port, String ip) {
		this.receiverIpAddress = ip;
